...
set examples {
    {downloads/rmsx/AntunesLab-rmsx/rmsx_demo_outputs/protease/combined viridis 9 0}
    {downloads/rmsx/AntunesLab-rmsx/rmsx_demo_outputs/protease_mask_example/combined magma 9 1}
    {downloads/rmsx/AntunesLab-rmsx/rmsx_demo_outputs/mask_multi_chain/combined turbo 9 1}
}
