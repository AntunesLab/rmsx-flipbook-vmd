...
proc run_smoke {} {
    ...
    set topology [file normalize [file join $workspace_root downloads rmsx AntunesLab-rmsx test_files 1UBQ.pdb]]
    set trajectory [file normalize [file join $workspace_root downloads rmsx AntunesLab-rmsx test_files mon_sys.dcd]]
    ...
    assert_true [file isfile [file join $output_dir [::RMSXFlipbookTimeline::NativeAnalysis::output_sentinel_name]]] "all-chain progress run did not write output sentinel"
