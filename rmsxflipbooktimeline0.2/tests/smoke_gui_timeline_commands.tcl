...
proc tk_getSaveFile {args} {
    return [file normalize [file join /tmp rmsxflipbooktimeline-gui-export-[pid].out]]
}
...
set tml_path [file normalize [file join /tmp rmsxflipbooktimeline-gui-command-[pid].tml]]
...
set rmsx_folder [file normalize [file join /tmp rmsxflipbooktimeline-gui-rmsx-folder-[pid]]]
...
set collection_dir [file normalize [file join /tmp rmsxflipbooktimeline-gui-command-collection-[pid]]]
