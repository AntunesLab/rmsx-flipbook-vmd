...
output_folder="${RMSXFLIPBOOKTIMELINE_DEMO_OUTPUT_FOLDER:-${RMSXFLIPBOOK_DEMO_OUTPUT_FOLDER:-${workspace_root}/outputs/native-rmsx-real-multichain-protease/combined}}"
topology="${RMSXFLIPBOOKTIMELINE_DEMO_TOPOLOGY:-${RMSXFLIPBOOK_DEMO_TOPOLOGY:-${workspace_root}/downloads/rmsx/AntunesLab-rmsx/test_files/protease_backbone.pdb}}"
trajectory="${RMSXFLIPBOOKTIMELINE_DEMO_TRAJECTORY:-${RMSXFLIPBOOK_DEMO_TRAJECTORY:-${workspace_root}/downloads/rmsx/AntunesLab-rmsx/test_files/short_protease_backbone.dcd}}"
native_output="${RMSXFLIPBOOKTIMELINE_DEMO_NATIVE_OUTPUT:-${RMSXFLIPBOOK_DEMO_NATIVE_OUTPUT:-${workspace_root}/outputs/native-rmsx-real-multichain-protease}}"
chain="${RMSXFLIPBOOKTIMELINE_DEMO_CHAIN:-${RMSXFLIPBOOK_DEMO_CHAIN:-all}}"
...
mask_selection="${RMSXFLIPBOOKTIMELINE_DEMO_MASK_SELECTION:-${RMSXFLIPBOOK_DEMO_MASK_SELECTION:-resid 45:55}}"
