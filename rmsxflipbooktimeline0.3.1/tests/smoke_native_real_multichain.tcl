...
set topology [file join $workspace_root fixtures upstream test_files protease_backbone.pdb]
set trajectory [file join $workspace_root fixtures upstream test_files short_protease_backbone.dcd]
...
set guard_output [file normalize [file join $::env(TMPDIR) "rmsxflipbooktimeline_multichain_slice_guard_[pid]"]]
