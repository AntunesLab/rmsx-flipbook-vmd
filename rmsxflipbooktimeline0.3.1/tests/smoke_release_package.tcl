...
set plugin_dir [file join $plugin_parent rmsxflipbooktimeline0.3.1]
...
if {[package provide rmsxflipbooktimeline] ne "0.3.1"} {
    smoke_fail "expected package version 0.3.1, got [package provide rmsxflipbooktimeline]"
}
...
if {[dict get $about package] ne "rmsxflipbooktimeline" || [dict get $about version] ne "0.3.1"} {
...
foreach needle {
    VMDPLUGINPATH
    "plugins/noarch/tcl/rmsxflipbooktimeline0.3.1"
