...
expect {[::RMSXFlipbookTimeline::Dashboard::result_total_frame_count {total_frame_count 317 frame_offset 1}] == 316} "Source frame count included the topology's initial coordinates"
expect {[::RMSXFlipbookTimeline::Dashboard::result_total_frame_count {chain_results {{total_frame_count 28 frame_offset 1}}}] == 27} "All-chain source frame count included the topology frame"
