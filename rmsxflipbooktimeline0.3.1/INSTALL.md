...
This copies the package to `$HOME/vmd-plugins/tcl/rmsxflipbooktimeline0.3.1` and
...
`plugins/noarch/tcl/rmsxflipbooktimeline0.3.1/`, or
`$HOME/vmd-plugins/tcl/rmsxflipbooktimeline0.3.1/`.
